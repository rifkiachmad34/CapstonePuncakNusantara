            ...
            <nav class="level is-mobile">
              <div class="level-left" >
                ...
                <span class="icon is-small" >
                  <i class="fa ${class_heart}"  area-hidden="true" style="color: red;"></i>
                </span>&nbsp;<span class="like-num" style="color: red;">${num2str(post['count_heart'])}</span>
              </a>
                <a class="level-item is-sparta" aria-label="star" onclick="toggle_star('${post['_id']}','star')">
                <span class="icon is-small" >
                  <i class="fa ${class_star}"  area-hidden="true" style="color: yellow;"></i>
                </span>&nbsp;<span class="like-num" style="color: black;">${num2str(post['count_star'])}</span>
              </a>
                <a class="level-item is-sparta" aria-label="thumbsup" onclick="toggle_thumbsup('${post['_id']}','thumbsup')">
                <span class="icon is-small" >
                  <i class="fa ${class_thumbsup}"  area-hidden="true" style="color: blue;"></i>
                </span>&nbsp;<span class="like-num" style="color: blue;">${num2str(post['count_thumbsup'])}</span>
              </a>
              </div>
            </nav>
          </div>
